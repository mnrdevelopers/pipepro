...
const SUPPLIER_TYPES = [
    'Cement', 'Dust/Sand', 'Aggregate', 'Steel', 'Fly Ash',
    'Admixtures', 'Moulds/Equipment', 'Logistics', 'General'
];
...
function exportSuppliersCSV() {
    ...
    const headers = ['Name', 'Type', 'Contact Person', 'Phone', 'Email', 'Address', 'GSTIN', 'Total Purchase', 'Balance'];
...
function getTypeBadge(type) {
    const map = {
        ...
        'Aggregate': 'bg-dark',
        'Steel': 'bg-danger',
        'Fly Ash': 'bg-info text-dark',
        'Admixtures': 'bg-secondary',
        'Moulds/Equipment': 'bg-primary',
