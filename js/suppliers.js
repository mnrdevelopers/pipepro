...
window.editSupplier = (id) => {
    ...
    if (document.getElementById('supplierDistrict')) document.getElementById('supplierDistrict').value = s.district || '';
    if (document.getElementById('supplierState')) document.getElementById('supplierState').value = s.state || '';
