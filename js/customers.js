...
// Customer Types for Pipes Business
        ...
        <tr data-id="${customer.id}">
            ...
            <td>
                <div class="btn-group btn-group-sm">
                    ...
                    <button class="btn btn-outline-info add-project" title="Add Project">
...
function setupEventListeners() {
    ...
    // Filter by Type
    if (filterType) {
        filterType.addEventListener('change', filterCustomersByType);
    }
    ...
    document.addEventListener('click', (e) => {
        ...
        if (e.target.closest('.view-customer')) {
            ...
            addProjectForCustomer(customer);
...
function viewCustomerDetails(customer) {
    ...
    document.getElementById('detailCityStateZip').textContent = 
        `${customer.city || ''} ${customer.state || ''} ${customer.zip || ''}`.trim() || 'N/A';
    ...
    // Update stats
    document.getElementById('detailTotalProjects').textContent = customer.totalProjects || 0;
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="stats-grid">
                                            <div class="stat-item">
                                                <div class="stat-value" id="detailTotalProjects">0</div>
...
async function deleteCustomer(customerId) {
    ...
    try {
        ...
        if (!projectsSnapshot.empty) {
            if (!confirm('This customer has associated projects. Do you want to continue deleting?')) {
                return;
            }
        }
...
function addProjectForCustomer(customer) {
    ...
    sessionStorage.setItem('openProjectModal', 'true');
...
async function exportCustomers() {
    try {
        ...
        // Convert to CSV
        const headers = ['Name', 'Email', 'Phone', 'Company', 'Type', 'Status', 'Total Projects', 'Total Spent'];
